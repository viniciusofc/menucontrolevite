...
const Table = ({children}) => {
    ...
    return (
        <div className="flex flex-col justify-between h-screen w-full  max-h-screen p-5 bg-zinc-200">
            {children}
            <div class="relative h-[32rem] max-w-4/5 overflow-auto shadow-md sm:rounded-lg ">
